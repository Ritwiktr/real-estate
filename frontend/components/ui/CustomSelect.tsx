  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={`min-w-[100px] rounded-none border border-white/20 bg-white/5 px-4 py-2.5 text-left text-sm text-white focus:border-white/40 focus:outline-none ${className ?? ""}`}
      >
        {display}
      </button>
      {open && (
