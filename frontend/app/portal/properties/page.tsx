    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <Link
          ...
          className="inline-flex rounded-lg bg-white px-4 py-2.5 text-sm font-medium text-black transition hover:bg-neutral-200"
        >
          Add property
        </Link>
      </div>
      ...
      <div className="mt-6 space-y-3">
        {list?.items.length === 0 && (
          <div className="rounded-xl border border-white/10 bg-neutral-900/50 p-8 text-center">
            <p className="text-neutral-400">You have no properties yet.</p>
        ...
        {list?.items.map((p) => (
          <Link
            ...
            className="block rounded-xl border border-white/10 bg-neutral-900/50 p-4 transition hover:border-white/20 hover:bg-neutral-900/70 sm:flex sm:items-center sm:justify-between"
          >
            <div className="flex gap-4">
              {p.images?.[0]?.url ? (
                ...
                <div className="h-20 w-28 flex-shrink-0 rounded-lg bg-neutral-800" />
              )}
              <div>
            ...
            <div className="mt-2 flex gap-4 text-sm text-neutral-500 sm:mt-0">
